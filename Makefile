...
#    Updated: 2018/01/20 16:42:21 by wblondel    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
SRC_PATH = src
SRC_NAME = clicks.c hooks_init.c hooks_keyboard.c hooks_mouse.c hooks_others.c\
			image.c import.c init.c keys.c main.c map.c render.c
